...
export const me = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(`${backend}/auth/me`)
      console.log(data)
...
export const getClassInfo = (id) => {
  ...
  return async (dispatch) => {
    console.log('Hi')
    try {
      let { data } = await axios.get(`${backend}/api/search/class/${id}`)
      console.log(data)
...
export const getClassReviews = (id) => {
  ...
  return async (dispatch) => {
    console.log('Hi')
    try {
      let { data } = await axios.get(`${backend}/api/review/${id}`)
      console.log(data)
...
export const getClassFiles = (id) => {
  ...
  return async (dispatch) => {
    console.log('Hi')
    try {
      let { data } = await axios.get(`${backend}/api/file/${id}`)
      console.log(data)
...
const rootReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case GET_CLASS_REVIEWS:
      return {
        ...state,
        classReviews: action.payload,
      }
    case ADD_NEW_REVIEW:
      return {
        ...state,
        newReviewMSG: action.payload,
      }
    case ADD_NEW_FILE:
      return {
        ...state,
        newFileMSG: action.payload,
      }
    case GET_ALL_FILES:
      return {
        ...state,
        allClassFiles: action.payload,
      }
    default:
      return state
  }
